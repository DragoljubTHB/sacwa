...
keywords={shadowJar, as, assert, break, case, catch ,class,const,continue,def,default,do,else,enum,extends
...
\begin{lstlisting}[language=Groovy,caption={Abhängigkeiten für Lambda in Java},label={lst:gradle}]
