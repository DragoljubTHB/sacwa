...
Serverless kann als ein Ansatz beschrieben werden, dar die Verwendung von einem Rechen-Service, Dienste von Drittanbieter, von \acrfull{API}s, und die Anwendung von Architekturmustern( wie ein Front-End, dass direkt mit Services kommunizieren anhand eines \glqq Delegation-Tokens\grqq\ ) fördert. \acrshort{FaaS} ist nur ein Aspekt dessen.
