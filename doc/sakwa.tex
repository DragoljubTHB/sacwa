...
Wie in der Sektion von \acrshort{SOA}\ref{sec:soa} erwähnt wurde, das gezwungene Separation of Concerns bringt das \acrfull{SRP} mit sich. Funktionen werden dadurch mehr überprüfbar.



Deren Vernetzung erlaubt komplexe Systeme zu entwerfen, die dank der zustandslose Natur der Funktionen schnell zu skalieren sind.
Diese Vernetzung kann durch einen Push basierte ereignisgetriebene Pipeline.
\newacronym{MVC}{MVC}{Model View Controller}
Die Komplexität und längerfristige Wartbarkeit des Systems lässt sich dadurch reduzieren, in dem 
Um die Komplexität des Systems zu reduzieren und die längerfristige Wartbarkeit zu verbessern, wird der Controller und/oder der Router aus dem \acrfull{MVC} \cite{fowlerBlogMVC} im Client und Third Party Dienste hinzugefügt.\cite{patternAWS}
