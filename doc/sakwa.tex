...
Hier ein Überblick über verschiedene Serverless Angebote:\\
...
Da die \acrshort{PaaS} und \acrshort{IaaS} für Stunde abgerechnet werden, und die \acrshort{FaaS} für Anfrage. Schließt sich daraus, dass der Preis und die Performanz für Anfrage, invers proportional auf die Anzahl ist.


\paragraph{Nachteile} zunächst,
  % - revise
...
Da der Architekturentwurf komplexer wird, bietet sich die Implementierung von unterstützende Werkzeuge, die einen kohärenten Entwurf, z.B durch Petrinetzmodellierung, erleichtern.
...
Die Komposition von unbekannten Inhalten in einer Benutzeroberfläche, wie es im Fall von einer \glqq Linked Data Driven\grqq\ Webanwendung, lässt sich mittels \acrshort{REST} Schnittstellen gestalten. Da können Dienste von Drittanbieter aufgerufen, und deren Inhalten einbetten. Als Parameter können deren Darstellung konfiguriert.
