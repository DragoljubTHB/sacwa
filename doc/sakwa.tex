...
@acronym MVP Minimal Viable Product : \cite{rady2016serverless} Das Ziel ist ein MVP Minimal Viable Product in form eine @acronym SPA Single Page Application mit ausschließlich \glqq Serverlosen\grqq Technologien vor zur Verfügung zu stellen.
...
Map Reduce and CGL Map Reduce\cite{king2016aws} 

MultiMilton and Erlang
