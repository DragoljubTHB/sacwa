...
Das Ziel der vorliegenden Bachelorarbeit war es, die Untersuchung der Flexibilität bei der Gestalltung von Webanwendungen mit ausschließlich Serverless Technologien. Dazu wurde eine Linked Data Driven Webanwendung anhand von Serverless Entwurfsmuster implementiert. Die Ergebnisse zeigten sowohl Schwierigkeiten bei Sitzungsverwaltung der Nutzern als auch eine große Freiheit bei der architektonischen Komposition von Diensten. Es wurde mit ER-Modellen, Ontologien, Protégé, dem europäischen Kompetenzmodell, SparQL, AWS Lambda, API Gateway, S3 empirisch und mit Architekturentwurfsmuster, OpenLambda, DynamoDB, SQS, SES, Kinesis Streams und SNS theoretisch gearbeitet. Diese Bacheloarbeit ist sowohl für Softwarearchitekten, Projektmanagern, Wirtschaftsinformatiker und Entwickler interessant. 

The goal of this bachelor thesis was the examination of the flexibility of a web application structure exclusively with Serverless architectures. A exemplary linked data driven web application was implemented. The results showed that on the one hand there are difficulties in the clients session management, and on the other hand there is big freedom at the architectural composition of services. It's been worked empirically with ER-Models, Ontologies, Protégé, the Europe's competency model, SparQL, AWS Lambda, API Gateway, S3 and theoretically with architectural design patterns, OpenLambda, DynamoDB, SQS, SES, Kinesis Streams and SNS. This bachelor thesis is interesting for software architects, project managers, economic computer scientists and developers.
