...
Caching zielt auf die Verbesserung der Performance und Skalabilität eines Systems ab, in dem es die oft gelesenen Daten temporär zwischenspeichert. Daher können wiederholte Zugriffe auf die Ontologie in einem Cache gepuffert werden. Hierzu bietet \acrshort{AWS} \glqq ElastiCache\grqq\ als Serverless Dienst. 
\begin{figure}[H]
	\begin{center}
...
Der Master pusht oder ( one-way ) synchronisiert seine Subordinate-Repliken. 
Diese Aufteilung favorisiert Leseoperationen.
