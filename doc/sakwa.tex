...
% STATE retrieval from other services such a DB
% Skale up and down to Zero
...
% revise 
Die starke Entkopplung ( siehe \autoref{sec:eda} ) von Diensten erfordert allerdings ihre Kohäsion. Daher gewinnt der Entwurfsphase eines Projekts bei Serverless Architekturen an Bedeutung.
...
Da HTTP und Lambda zustandslos sind, können die Sitzungen der Nutzer derzeit nur mithilfe von Datenbanken implementiert. Interaktionen die auf ältere basieren wurde in Front-End berücksichtigt. 

Der Einsatz von großen Mengen von Quellcode lässt sich nicht  ... 
...
Der Kontrollverlust über das Verhalten der Services kann die Entwurfsentscheidungen erschweren.
