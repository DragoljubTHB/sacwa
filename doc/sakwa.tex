...
Der Kompetenzstand einer Person ist mit dem EQF-Rahmen vergleichbar, und daher Internationell anerkenntbar.
Wenn diese Anwendung in Bildungsintitutionen eingesetzt wird, dienen die Rahmenlehrpläne als Leitphad für die belegung der einzelnen Kompetenzen
...
Um einen anerkenntbaren Kompetenzprofil zu gestallten, soll dieser von dritten erkenntbaren Kompetenzdefinitionen bestehen.
...
\subsection{Ontology}
Eine Ontologie ist eine formale Spezifikation von eine geteilten Konzeptualisation. Wird mit RDF beschrieben. 
