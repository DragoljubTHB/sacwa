...
Von Typ Task, informal IS-A

2-Consider reuse: aktuell keine umgesetzte Ontologie veröffentlicht: 
mix von moodle - RCD
%@pic: own mix for both
Die Ausgansontologie@Cite wird auf KOMAs Aufgaben angepasst.
